...
import Lotto from '../../Images/AboutUs/Clients/Lotto.png';
import Fooz from '../../Images/AboutUs/Clients/Fooz.png';
import Fork from '../../Images/AboutUs/Clients/Fork.png';
import Mind from '../../Images/AboutUs/Clients/Mind.png';
import Virus from '../../Images/AboutUs/Clients/Virus.png';
      ...
      <div className='OurClients-Content'>
        <div className='OurClients-Card'>
            ...
            <div className='OurClients-Card-Text'>
                ...
                <p>THE RESULTS:</p>
                <h1>
                    <b><CountUp start={120} end={1200} duration={2000}/> </b>{"+"}
                </h1>
        ...
        <div className='OurClients-Card'>
            ...
            <div className='OurClients-Card-Text'>
                ...
                <p>THE RESULTS:</p>
                <h1>
                    <b><CountUp start={20} end={200} duration={2000}/> </b>{"%+"}
                </h1>
        ...
        <div className='OurClients-Card'>
            ...
            <div className='OurClients-Card-Text'>
                ...
                <p>THE RESULTS:</p>
                <h1>
                    <b><CountUp start={4} end={35} duration={2000}/> </b>{"k+"}
                </h1>
